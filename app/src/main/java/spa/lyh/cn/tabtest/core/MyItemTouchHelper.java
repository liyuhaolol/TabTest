...
public class MyItemTouchHelper {
    ...
    public MyItemTouchHelper(final RecyclerView recycler, final RecyclerView.Adapter adapter, final List list){
...
//        ItemTouchHelperGestureListener原生不是public修饰的，需要把源码复制到项目里才能实例化
        ...
        setLongClickDelay(new Handler(), recycler, 1000, listener);
    }
