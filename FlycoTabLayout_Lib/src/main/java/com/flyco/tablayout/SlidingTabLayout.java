...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private int mSpecialTextSelectColor;
    private int mSpecialTextUnselectColor;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        //special
        mSpecialTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_special_textsize, 0);
        mSpecialTextSelectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_special_textSelectColor, Color.parseColor("#ffffff"));
        mSpecialTextUnselectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_special_textUnselectColor, Color.parseColor("#AAffffff"));
        mSpecialTextBold = ta.getInt(R.styleable.SlidingTabLayout_tl_special_textBold, TEXT_BOLD_NONE);
        mSpecialTextStart = ta.getInt(R.styleable.SlidingTabLayout_tl_special_textStart, -1);
        mSpecialTextEnd = ta.getInt(R.styleable.SlidingTabLayout_tl_special_textEnd, -1);
